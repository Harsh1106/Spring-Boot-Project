...
public class ProductController {
    ...
    @GetMapping("/products")
    public ResponseEntity<List<Product>> getProducts(){ //ResponseEntity return the status of our request
    ...
    @PostMapping("/product")
    public ResponseEntity<?> addProduct(@RequestPart Product product, @RequestPart MultipartFile imageFile){ //json + image data
